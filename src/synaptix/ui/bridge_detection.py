...
class BridgePanel(QWidget):
    ...
    def __init__(
        ...
        description = QLabel(
            (
                "Detect pairs of EEG electrodes "
                "with unusually low electrical "
                "distance. Confirmed bridges are "
                "recorded but are not automatically "
                "deleted."
            )
        )
